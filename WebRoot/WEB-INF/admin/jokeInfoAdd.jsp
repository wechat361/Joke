...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <!-- menu.jsp   end -->
        <div class="span9">
        <form id="jokeFormId" action="${pageContext.request.contextPath }/admin/jokeInfo/save.do" method="post" enctype="multipart/form-data">
            <h1 class="page-title">新增笑话</h1>
			...
			<div class="well">
				标题：<input type="text" name="title" value="${jokeInfo.title}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	来源：<input type="text" name="source" value="${jokeInfo.source}"><br>
