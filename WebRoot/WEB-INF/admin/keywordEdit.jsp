...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <!-- menu.jsp   end -->
        <div class="span9">
        <form id="keywordFormId" action="${pageContext.request.contextPath }/admin/keyword/update.do" method="post" enctype="multipart/form-data">
            <input type="hidden" value="${keyword.id }" name="id"/>
            <h1 class="page-title">编辑禁词</h1>
			...
			<div class="well">
            	...
            	状态：
				<select name="state">
            		<c:if test="${keyword.state==1 }" var="flag">
				...
				禁词：&nbsp;<input name="keyword" value="${keyword.keyword}" type="text"/>
			</div>
